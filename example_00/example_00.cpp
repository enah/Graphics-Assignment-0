...
void myDisplay() {
  ...
  glBegin(GL_POLYGON);
  glVertex3f(a * cos(deg), b * sin(deg), 0.0f);                // top tip of triangle
  glVertex3f(-foci, basey, 0.0f);               // lower left corner of triangle
  glVertex3f(foci, basey, 0.0f);               // lower right corner of triangle
  glEnd();
  //-----------------------------------------------------------------------
